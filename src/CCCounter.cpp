...
CCCounter::CCCounter()
{
	...
	file_extension.push_back(".inl");	// inline files for example see Boost libraries

	// These file types are not included when doing Cyclomatic Complexity calculations
	...
	file_extension.push_back(".inc");	// include files for example see Linux
