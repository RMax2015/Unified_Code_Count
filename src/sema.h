...
// Changed from release above by adding 
// #ifdef _CPP_2011_AVAILABLE_  to indicate if C++ compiler has 2011 support
// in 3 places below by Randy Maxwell
//
...
#endif	// #ifdef	_CPP_2011_AVAILABLE_
